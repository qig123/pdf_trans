...
1.3  Classifcation of programming languages  1.4  GCD function in C  1.5  GCD function in OCaml  1.6  GCD rules in Prolog

11  Specifying Syntax: Regular Expressions and Context-Free  13  Grammars  13  2.2  Lexical structure of C11  45  13  2.3  Syntax of numeric constants  46  2.4  Syntactic nesting in expressions  48  2.5  Extended BNF (EBNF)  49  2.6  Derivation of slope * x + intercept  50  17  2.7  Parse trees for slope * x + intercept  51  17  2.8  Expression grammar with precedence  18  and associativity  52  19  Scanning  19

Why Study Programming Languages?

Compilation and Interpretation

1.7  Pure compilation  1.8  Pure interpretation  1.9  Mixing compilation and interpretation  1.10  Preprocessing  1.11  Library routines and linking  1.12  Post-compilation assembly  1.13  The C preprocessor  1.14  Source-to-source translation  1.15  Bootstrapping  1.16  Compiling interpreted languages  1.17  Dynamic and just-in-time compilation  1.18  Microcode (frmware)

2.9  Tokens for a calculator language  54 20

2.10  An ad hoc scanner for calculator tokens  54  20

2.11  Finite automaton for a calculator scanner  55 20

2.12  Constructing an NFA for a given regular  21

expression  58  23  2.13  NFA for d*( .d | d. ) d*  59 23  2.14  DFA for d*( .d | d. ) d*  60 24  2.15  Minimal DFA for d*( .d | d. ) d*  60  2.16  Nested case statement automaton  62  2.17  The nontrivial prefx problem  64  2.18  Look-ahead in Fortran scanning  64  26  2.19  Table-driven scanning  65  28

Programming Environments

An Overview of Compilation

1.19  Phases of compilation and interpretation  1.20  GCD program in C  1.21  GCD program tokens  1.22  Context-free grammar and parsing  1.23  GCD program parse tree  1.24  GCD program abstract syntax tree

Parsing  28  28  2.20  Top-down and bottom-up parsing  70  29  2.21  Bounding space with a bottom-up  33  grammar  72

2.60  0n 1n is not a regular language  C·19  2.61  Separation of grammar classes  C·20  2.62  Separation of language classes  C·20
...
3.4  Static variables in C  127  3.5  Nested scopes  128  3.6  Static chains  130  3.7  A “gotcha” in declare-before-use  131  3.8  Whole-block scope in C#  132  3.9  “Local if written” in Python  132  3.10  Declaration order in Scheme  132  3.11  Declarations vs defnitions in C  133  3.12  Inner declarations in C  134  3.13  Pseudorandom numbers as a motivation  for modules  136  3.14  Pseudorandom number generator in  C++  137  3.15  Module as “manager” for a type  138  3.16  A pseudorandom number generator  type  140  3.17  Modules and classes in a large application  142  3.18  Static vs dynamic scoping  143  3.19  Run-time errors with dynamic scoping  144
...
3.20  Aliasing with parameters  146  3.21  Aliases and code improvement  146  3.22  Overloaded enumeration constants in  Ada  147  3.23  Resolving ambiguous overloads  147  3.24  Overloading in C++  148  3.25  Operator overloading in Ada  148  3.26  Operator overloading in C++  148  3.27  Infx operators in Haskell  149  3.28  Overloading with type classes  149  3.29  Printing objects of multiple types  150
...
5.2  Big- and little-endian  C·63  5.3  Hexadecimal numbers  C·65  5.4  Two’s complement  C·66  5.5  Overfow in two’s complement addition  C·66  5.6  Biased exponents  C·68  5.7  IEEE foating-point  C·68

Evaluating Attributes

4.6  Decoration of a parse tree  187  4.7  Top-down CFG and parse tree for  subtraction  188  4.8  Decoration with left-to-right attribute  fow  188  4.9  Top-down AG for subtraction  189  4.10  Top-down AG for constant expressions  189  4.11  Bottom-up and top-down AGs to build a  syntax tree  193
...
5.14  Performance = clock rate  C·88  5.15  Filling a load delay slot  C·91  5.16  Renaming registers for scheduling  C·92  5.17  Register allocation for a simple loop  C·93  5.18  Register allocation and instruction  scheduling  C·95
...
6.1  A typical function call  225  6.2  Typical operators  225  6.3  Cambridge Polish (prefx) notation  225  6.4  Juxtaposition in ML  225  6.5  Mixfx notation in Smalltalk  226  6.6  Conditional expressions  226  6.7  A complicated Fortran expression  226  6.8  Precedence in four infuential languages  227  6.9  A “gotcha” in Pascal precedence  227  6.10  Common rules for associativity  227  6.11  User-defned precedence and associativity in Haskell  228  6.12  L-values and r-values  230  6.13  L-values in C  230  6.14  L-values in C++  231  6.15  Variables as values and references  231  6.16  Wrapper classes  232  6.17  Boxing in Java 5 and C#  232  6.18  Expression orientation in Algol 68  233  6.19  A “gotcha” in C conditions  234  6.20  Updating assignments  234  6.21  Side effects and updates  235  6.22  Assignment operators  235  6.23  Prefx and postfx inc/dec  235  6.24  Advantages of postfx inc/dec  236  6.25  Simple multiway assignment  236  6.26  Advantages of multiway assignment  236  6.27  Programs outlawed by defnite assignment  239  6.28  Indeterminate ordering  240  6.29  A value that depends on ordering  241  6.30  An optimization that depends on  ordering  241  6.31  Optimization and mathematical “laws”  242  6.32  Overfow and arithmetic “identities”  243  6.33  Reordering and numerical stability  243
...
C·107  C·107  C·108  C·108  275  275  275  276  276  276
...
Simple generator in Icon  A generator inside an expression  Generating in search of success  Backtracking with multiple generators  while loop in Algol-W  Post-test loop in Pascal and Modula  Post-test loop in C  break statement in C  Exiting a nested loop in Ada  Exiting a nested loop in Perl

6.89  6.90  6.91  6.92  6.74  6.75  6.76  6.77  6.78  6.79

Type Checking

7.17  Trivial differences in type  313  7.18  Other minor differences in type  313  7.19  The problem with structural equivalence  314  7.20  Alias types  314  7.21  Semantically equivalent alias types  315  7.22  Semantically distinct alias types  315  7.23  Derived types and subtypes in Ada  315  7.24  Name vs structural equivalence  316  7.25  Contexts that expect a given type  316  7.26  Type conversions in Ada  317  7.27  Type conversions in C  318  7.28  Unchecked conversions in Ada  319  7.29  Conversions and nonconverting casts in  C++  319  7.30  Coercion in C  320  7.31  Coercion vs overloading of addends  322  7.32  Java container of Object  323  7.33  Inference of subrange types  324  7.34  Type inference for sets  325  7.35  var declarations in C#  325  7.36  Avoiding messy declarations  325  7.37  decltype in C++11  326  7.38  Fibonacci function in OCaml  327  7.39  Checking with explicit types  327  7.40  Expression types  328  7.41  Type inconsistency  328  7.42  Polymorphic functions  329  7.43  A simple instance of unifcation  330

Recursion

278  278  278  279  279  280  281  281

6.80  6.81  6.82  6.83  6.84  6.85  6.86  6.87  6.88

A “naturally iterative” problem  A “naturally recursive” problem  Implementing problems “the other way”  Iterative implementation of tail recursion  By-hand creation of tail-recursive code  Naive recursive Fibonacci function  Linear iterative Fibonacci function  Effcient tail-recursive Fibonacci function  Lazy evaluation of an infnite data  structure  Avoiding asymmetry with nondeterminism  Selection with guarded commands  Looping with guarded commands  Nondeterministic message receipt  Nondeterministic server in SR  Naive (unfair) implementation of nondeterminism  “Gotcha” in round-robin implementation  of nondeterminism

283

6.93

C·110  C·110  C·111  C·112  C·112
...
void (trivial) type  Making do without void  Option types in OCaml  Option types in Swift  Aggregates in Ada  Enumerations in Pascal  Enumerations as constants  Converting to and from enumeration  type  Distinguished values for enums

7.4  7.5  7.6  7.7  7.8  7.9  7.10  7.11

303  303  303  304  304  307  308
...
8.54  8.55  8.56  8.57  8.58  8.70  8.71  8.72  8.73  8.74  8.75  8.76  8.77  8.78  8.79  8.80  8.81  8.82  8.83  8.84

398  399  400  400  400  C·150  C·150  C·150  C·152  C·152  C·153  C·153  C·154  C·154  C·155  C·155  C·156  C·157  C·157  C·158
...
9.1  Layout of run-time stack (reprise)  9.2  Offsets from frame pointer  9.3  Static and dynamic links  9.4  Visibility of nested routines

412  412  412  413

Calling Sequences

9.5  9.56  9.57  9.58  9.59  9.60  9.61  9.62  9.63  9.6  9.7

A typical calling sequence  Nonlocal access using a display  LLVM/ARM stack layout  LLVM/ARM calling sequence  gcc/x86-32 stack layout  gcc/x86-32 calling sequence  Subroutine closure trampoline  The x86-64 red zone  Register windows on the SPARC  Requesting an inline subroutine  In-lining and recursion

415  C·163  C·167  C·170  C·172  C·172  C·174  C·175  C·177  419  420
...
Infx operators  Control abstraction in Lisp and Smalltalk  Passing an argument to a subroutine  Value and reference parameters  Call by value/result  Emulating call-by-reference in C
...
Operations as messages in Smalltalk  Mixfx messages  Selection as an ifTrue: ifFalse:  message  Iterating with messages  Blocks as closures  Logical looping with messages  Defning control abstractions  Recursion in Smalltalk

C·205  C·205  C·206  C·206  C·206  C·207
...
539  540  540  540  541  541  541  542  542  542  543  543  544  545  545  545  545  546  547  548

The read-eval-print loop  Signifcance of parentheses  Quoting  Dynamic typing  Type predicates  Liberal syntax for symbols  lambda expressions  Function evaluation  if expressions  Nested scopes with let  Global bindings with define  Basic list operations  List search functions  Searching association lists  Multiway conditional expressions  Assignment  Sequencing  Iteration  Evaluating data as code  Simulating a DFA in Scheme
...
12.4  Atoms, variables, scope, and type  593  12.5  Structures and predicates  593  12.6  Facts and rules  593  12.7  Queries  594  12.8  Resolution in Prolog  595  12.9  Unifcation in Prolog and ML  595  12.10  Equality and unifcation  595  12.11  Unifcation without instantiation  596  12.12  List notation in Prolog  596  12.13  Functions, predicates, and two-way rules  597  12.14  Arithmetic and the is predicate  597  12.15  Search tree exploration  598
...
15.5  Simpler compiler structure  784  15.6  An attribute grammar for code generation  785  15.7  Stack-based register allocation  787  15.8  GCD program target code  788
...
15.10  Assembly as a fnal compiler pass  792  15.11  Direct generation of object code  794  15.12  Compressing nops  794  15.13  Relative and absolute branches  794  15.14  Pseudoinstructions  795  15.15  Assembler directives  795  15.16  Encoding of addresses in object fles  796
...
16.19  16.20  16.21  16.22  16.23  16.24  16.25  16.26  16.27  16.28  16.29  16.30  16.31  16.32  16.33  16.34  16.35  16.36  16.37  16.38
