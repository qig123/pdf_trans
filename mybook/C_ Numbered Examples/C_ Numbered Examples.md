...
73
2.23
Recursive descent parser for the calcula-
tor language
75
2.24
...
C*·*3
2.47
Reducing cascading errors with context-
speciﬁc look-ahead
C*·*4
2.48
...
134
3.13
Pseudorandom numbers as a motivation
for modules
136
3.14
Pseudorandom number generator in
C++
137
3.15
...
160
3.40
Variable capture in C++ lambda expres-
sions
161
3.41
...
185
4.5
Top-down AG to count the elements of
a list
185
...
227
6.11
User-deﬁned precedence and associativ-
ity in Haskell
228
6.12
...
236
6.27
Programs outlawed by deﬁnite assign-
ment
239
6.28
...
329
7.43
A simple instance of uniﬁcation
330
...
C*·*112
6.98
Naive (unfair) implementation of non-
determinism
C*·*113
6.99
...
7.1
Operations that leverage type informa-
tion
297
7.2
...
297
7.3
Types as a source of “may alias” informa-
tion
298
...
C*·*122
7.61
Instantiation-time errors in C++ tem-
plates
C*·*122
7.62
...
358
8.59
Nested structs and unions in tradi-
tional C
C*·*136
8.60
...
435
9.26
Self-documentation with named parame-
ters
436
9.27
...
C*·*189
9.75
Sleeping in anticipation of future execu-
tion
C*·*189
...
481
10.15
The problem with type-speciﬁc exten-
sions
482
10.16
...
C*·*194
10.59
Method invocation with multiple inheri-
tance
C*·*195
10.60
this correction
...
C*·*200
10.67
Overriding methods with shared inheri-
tance
C*·*201
10.68
...
11.28
A recursive nested function (reprise of
Example 7.38)
555
11.29
...
562
11.48
Pattern matching against a tuple returned
from a function
562
11.49
...
C*·*216
11.92
Nonterminating applicative-order reduc-
tion
C*·*217
11.93
...
647
13.21
Cooperative multithreading on a unipro-
cessor
648
13.22
A race condition in preemptive multi-
threading
650
13.23
...
709
14.11
Problematic spaces in ﬁle names
709
14.12
...
746
14.51
Trailing modiﬁers on RE matches
746
14.52
...
784
15.6
An attribute grammar for code genera-
tion
785
15.7
...
15.10
Assembly as a ﬁnal compiler pass
792
15.11
