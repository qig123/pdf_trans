...
1.26  GCD program assembly code  34 5

1.27  GCD program optimization  36 5

1.1  GCD program in x86 machine language

1.2  GCD program in x86 assembler
...
1.3  Classifcation of programming languages

1.4  GCD function in C

1.5  GCD function in OCaml

1.6  GCD rules in Prolog

11  Specifying Syntax: Regular Expressions and Context-Free  13  Grammars  13

2.2  Lexical structure of C11  45  13
...
2.6  Derivation of slope * x + intercept  50  17

2.7  Parse trees for slope * x + intercept  51  17

2.8  Expression grammar with precedence  18  and associativity  52  19  Scanning  19

Why Study Programming Languages?

Compilation and Interpretation

1.7  Pure compilation

1.8  Pure interpretation

1.9  Mixing compilation and interpretation

1.10  Preprocessing

1.11  Library routines and linking

1.12  Post-compilation assembly

1.13  The C preprocessor

1.14  Source-to-source translation

1.15  Bootstrapping

1.16  Compiling interpreted languages

1.17  Dynamic and just-in-time compilation

1.18  Microcode (frmware)
...
2.13  NFA for d*( .d | d. ) d*  59 23

2.14  DFA for d*( .d | d. ) d*  60 24

2.15  Minimal DFA for d*( .d | d. ) d*  60

2.16  Nested case statement automaton  62

2.17  The nontrivial prefx problem  64

2.18  Look-ahead in Fortran scanning  64  26

2.19  Table-driven scanning  65  28

Programming Environments

An Overview of Compilation

1.19  Phases of compilation and interpretation

1.20  GCD program in C

1.21  GCD program tokens

1.22  Context-free grammar and parsing

1.23  GCD program parse tree

1.24  GCD program abstract syntax tree

Parsing  28  28

2.20  Top-down and bottom-up parsing  70  29

2.21  Bounding space with a bottom-up  33  grammar  72

2.60  0n 1n is not a regular language  C·19

2.61  Separation of grammar classes  C·20

2.62  Separation of language classes  C·20
...
2.47  Reducing cascading errors with context- specifc look-ahead  C·4
...
3.2  Layout of the run-time stack  120
...
3.11  Declarations vs defnitions in C  133
...
3.46  Symbol table for a sample program  C·28
...
3.27  Infx operators in Haskell  149
...
3.32  Returning a frst-class subroutine in  Scheme  156
...
5.5  Overfow in two’s complement addition  C·66

5.6  Biased exponents  C·68

5.7  IEEE foating-point  C·68
...
4.8  Decoration with left-to-right attribute  fow  188
...
5.14  Performance = clock rate  C·88
...
6.39  Control fow with gotos in Fortran  246
...
6.3  Cambridge Polish (prefx) notation  225

6.4  Juxtaposition in ML  225

6.5  Mixfx notation in Smalltalk  226

6.6  Conditional expressions  226

6.7  A complicated Fortran expression  226

6.8  Precedence in four infuential languages  227

6.9  A “gotcha” in Pascal precedence  227

6.10  Common rules for associativity  227

6.11  User-defned precedence and associativ­ ity in Haskell  228
...
6.23  Prefx and postfx inc/dec  235

6.24  Advantages of postfx inc/dec  236

6.25  Simple multiway assignment  236

6.26  Advantages of multiway assignment  236

6.27  Programs outlawed by defnite assign­ ment  239
...
6.32  Overfow and arithmetic “identities”  243
...
7.23  Derived types and subtypes in Ada  315
...
7.43  A simple instance of unifcation  330
...
7.1  Operations that leverage type informa­ tion

7.2  Errors captured by type information

7.3  Types as a source of “may alias” informa­ tion
...
7.59  Template function bodies moved to a .c  fle  C·121
...
8.2  Accessing record felds  352
...
8.10  Minimizing holes by sorting felds  356
...
8.65  A discriminated subtype in Ada  C·141
...
9.1  Layout of run-time stack (reprise)

9.2  Offsets from frame pointer

9.3  Static and dynamic links

9.4  Visibility of nested routines
...
9.70  Initialization of a coroutine-based traffc  simulation  C·187

9.71  Traversing a street segment in the traffc  simulation  C·188

9.72  Scheduling a coroutine for future  execution  C·188

9.73  Queueing cars at a traffc light  C·188
...
10.32  Specifcation of base class constructor  arguments  502

10.33  Specifcation of member constructor  arguments  502
...
10.5  Method declaration without defnition  476

10.6  Separate method defnition  477
...
10.10  Redefning a method in a derived class  479
...
10.15  The problem with type-specifc exten­ sions  482
...
11.35  Mutable felds  558

11.36  References  558

11.37  Variants as enumerations  558
...
Replicated inheritance in Eiffel  Using replicated inheritance  Overriding methods with shared inheri­ tance  Implementation of shared inheritance
...
12.18  Infnite regression  600

12.19  Tic-tac-toe in Prolog  600

12.20  The cut  604  12.21  \+ and its implementation  605
...
12.45  Theorem proving as a search for  contradiction  C·229
...
11.76  Declarative (nonconstructive) function  defnition  580
...
11.87  Naming functions for future reference  C·215
...
11.95  The fxed-point combinator Y  C·218
...
12.9  Unifcation in Prolog and ML  595

12.10  Equality and unifcation  595

12.11  Unifcation without instantiation  596

12.12  List notation in Prolog  596

12.13  Functions, predicates, and two-way rules  597

12.14  Arithmetic and the is predicate  597
...
13.12  Elaborated tasks in Ada  641
...
13.26  Barriers in fnite element analysis  655

13.27  The “sense-reversing” barrier  656
...
14.9  Redirection of stderr and stdout  708

14.10  Heredocs (in-line input)  709

14.11  Problematic spaces in fle names  709
...
14.16  User-defned shell functions  710

14.17  The #! convention in script fles  711
...
13.41  How to wait for a signal (hint or absolute)  671
...
14.38  Superassignment in R  740
...
14.42  Extra quantifers in POSIX REs  744
...
14.47  Predefned POSIX character classes  745
...
14.51  Trailing modifers on RE matches  746
...
14.57  Dissecting a foating-point literal  750

14.58  Implicit capture of prefx, match, and  suffx  750
...
14.68  Confated types in PHP, Tcl, and  JavaScript  755
...
15.19  GCD program in GIMPLE  C·273
...
15.10  Assembly as a fnal compiler pass  792
...
15.16  Encoding of addresses in object fles  796
...
15.21  PIC under x86/Linux  C·280
...
17.11  Syntax tree and naive control fow graph  C·305
...
17.15  Data fow equations for available  expressions  C·317
...
17.19  Data fow equations for live variables  C·321

17.20  Fixed point for live variables  C·321

17.21  Data fow equations for reaching  defnitions  C·324
...
16.2  Constants for “Hello, world”

16.3  Bytecode for a list insert operation

16.39  Generics in the CLI and JVM

16.40  CIL for a list insert operation
