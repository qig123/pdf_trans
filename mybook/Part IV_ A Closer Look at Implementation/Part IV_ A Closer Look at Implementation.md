...
* What is a hot path? Why is it signiﬁcant?
* Underwhat circumstances can a JIT compiler expand virtual methods in-line?
...
* What is binary rewriting? How does it differ from binary translation and dy-
  namic optimization?
* Describe the notion of a partial execution trace. Why is it important to dy-
...
* Name an aspect of reﬂection supported by the CLI but not by the JVM.
...
* What are javadoc, apt, JML, and LINQ, and what do they have to do with
  annotation?
* Brieﬂy describe three different implementation strategies for a symbolic de-
  bugger.
